        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="category" class="nav-item nav-link"><i class="fa fa-keyboard me-2"></i>Category</a>
                    <a href="product" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Products</a>
                    <a href="brand" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Brands</a>
                    <a href="/add" class="nav-item nav-link"><i class="fa fa-table me-2"></i>Add Admin</a>
